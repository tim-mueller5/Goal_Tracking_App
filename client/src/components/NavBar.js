    ...
    return (
        <div className={navDisplay}>
            <div className='grid grid-cols-2 grid-rows-2 max-w-sm m-auto'>
                <button onClick={goCreateGoal} className='border-solid border-black border-2 px-4 m-1 max-h-14 h-12 bg-blue-500 rounded-full shadow-lg shadow-gray-600 overflow-hidden hover:rounded-full hover:bg-blue-700 hover:border-gray-50 hover:text-gray-50 hover:shadow-white hover:shadow-inner'> Create New Goal </button>
                <button onClick={viewCompleted} className='border-solid border-black border-2 px-4 m-1 max-h-14 h-12 bg-blue-500 rounded-full shadow-lg shadow-gray-600 overflow-hidden hover:rounded-full hover:bg-blue-700 hover:border-gray-50 hover:text-gray-50 hover:shadow-white hover:shadow-inner'>Completed Goals</button>
