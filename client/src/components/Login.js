...
function Login( ) {
    ...
    return (
        ...
        <div className='text-center overflow-auto min-h-screen mt-24'>
            ...
            <p>{error}</p>
            <p className="text-xl font-bold m-10">Welcome to my app!<br/> A website for tracking and accomplishing goals all while having fun! <br/> Set grand goals and then break them down into daily habits and single tasks that will get you to success!<br/>Use items you find by completing goals to fight monsters!</p>
        </div>
